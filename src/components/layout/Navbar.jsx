...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 inset-x-0 z-50 px-4 py-3">
      ...
      >
        {/* Logo */}
        <Link to="/" className="flex items-center gap-2.5 group shrink-0" aria-label="Studio Praiana Pole Dance">
          <span className="shrink-0 relative flex h-11 w-11 items-center justify-center overflow-hidden rounded-full transition-transform duration-500 group-hover:-rotate-6 group-hover:scale-110 bg-white shadow-sm ring-1 ring-primary/10">
            <img src={praianaLogo.url} alt="Studio Praiana Pole Dance" className="h-full w-full object-contain scale-[1.35]" />
          </span>
